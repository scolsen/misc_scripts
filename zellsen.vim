...
let g:colors_name = "zellsen"

hi Comment term=bold ctermfg=DarkMagenta guifg=Red
...
hi  StatusLine term=bold,reverse cterm=NONE ctermfg=White ctermbg=DarkGray gui=NONE guifg=Yellow guibg=DarkGray
